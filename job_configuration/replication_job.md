...
Also, when replicating VMs to a remote DR site, you can manage network traffic by applying traffic throttling rules or limiting the number of data transfer connections. See Veeam Backup & Replication User Guide for more information: <https://helpcenter.veeam.com/archive/backup/95/vsphere/setting_network_traffic_throttling.html>.

<<<<<<< HEAD
**Tip:** Replication can leverage WAN acceleration allowing a more effective use of the link between the source and remote sites. For more information, see the User Guide <https://helpcenter.veeam.com/archive/backup/95/vsphere/wan_acceleration.html> or the present document (the [WAN Acceleration](../resource_planning/wan_acceleration.md) section above).
=======
...
**Tip:** Replication can leverage WAN acceleration allowing a more effective use of the link between the source and remote sites. For more information, see the User Guide <https://helpcenter.veeam.com/archive/backup/95/vsphere/wan_acceleration.html> or the present document (the “WAN Acceleration“ section above).
>>>>>>> parent of 2492291... Merge branch 'master' into dev
...
<<<<<<< HEAD
You can find additional information about replica from backup in the appropriate section of the Veeam Backup & Replication User Guide: <https://helpcenter.veeam.com/archive/backup/95/vsphere/replica_from_backup.html>
=======
